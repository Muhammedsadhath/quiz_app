...
SECRET_KEY = 'django-insecure-l7xlxu)s@@aka#+3oxbl^yr31*00--*o887$6%gl98$0frett2'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['.vercel.app', 'localhost']  #THIS IS FOR DEPLYMENT
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', #THIS IS FOR DEPLYMENT
...
STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage' #THIS IS FOR DEPLYMENT
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'uAKDzQwHCAVXJNfjXVzmHIVssABxuUbL',
